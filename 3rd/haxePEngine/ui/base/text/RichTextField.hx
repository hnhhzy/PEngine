...
import haxePEngine.ui.base.text.RichTextObjectFactory;
...
import haxePEngine.ui.component.base.events.TextEvent;
...
import haxePEngine.ui.component.base.text.TextLineMetrics;
...
class RichTextField extends Sprite
{
    ...
    private function __linkClick(evt:Event):Void
    {
        ...
        // else
        //     haxePEngine.ui.component.base.Lib.getURL(new URLRequest(url), node.element.target);
    }
}
