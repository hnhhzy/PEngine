...
@:access(haxePEngine.ui.component.base.errors.Error)
...
class DisplayObjectContainer extends InteractiveObject
{
	...
	**/
	...
	// @:noCompletion @:dox(hide) public var textSnapshot (default, never):haxePEngine.ui.component.base.text.TextSnapshot;
