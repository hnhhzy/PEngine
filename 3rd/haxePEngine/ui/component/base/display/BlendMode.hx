...
/**
	...
	*  The `blendMode` property of the
	haxePEngine.ui.component.base.display.DisplayObject class.
	*  The `blendMode` parameter of the `draw()`
	method of the haxePEngine.ui.component.base.display.BitmapData class
**/
@:enum abstract BlendMode(Null<Int>)
{
	...
	**/
	...
	/**
		...
		`haxePEngine.ui.component.base.display.BlendMode.LAYER`.
	...
	**/
	...
	/**
		...
		display object be set to `haxePEngine.ui.component.base.display.BlendMode.LAYER`.
		Not supported under GPU rendering.
	**/
	public var ERASE = 4;
