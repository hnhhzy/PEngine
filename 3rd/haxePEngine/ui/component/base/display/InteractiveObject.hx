...
/**
	...
	@event gesturePan             Dispatched when the user moves a point of
								  ...
								  the haxePEngine.ui.component.base.ui.Multitouch class to manage touch
	...
	@event gesturePressAndTap     Dispatched when the user creates a point of
								  ...
								  haxePEngine.ui.component.base.ui.Multitouch class to manage touch
								  event handling(enable touch gesture event
								  handling, simple touch point event handling,
								  or disable touch events so only mouse events
								  are dispatched). If you choose to handle the
	...
	@event gestureTwoFingerTap    Dispatched when the user presses two points
								  ...
								  interaction. Use the haxePEngine.ui.component.base.ui.Multitouch
	...
	@event touchRollOut           Dispatched when the user moves the point of
								  ...
								  the current environment supports it. Choose
								  how you want to handle the user interaction.
								  Use the haxePEngine.ui.component.base.ui.Multitouch class to manage
...
{
	// @:noCompletion @:dox(hide) public var accessibilityImplementation:haxePEngine.ui.component.base.accessibility.AccessibilityImplementation;
	// @:noCompletion @:dox(hide) public var contextMenu:haxePEngine.ui.component.base.ui.ContextMenu;
	...
	**/
	...
	/**
		...
		`haxePEngine.ui.component.base.display.DisplayObjectContainer.mouseChildren`.
		 No event is dispatched by setting this property. You must use the
	...
	**/
	...
	{
		haxePEngine.ui.component.base.utils._internal.Lib.notImplemented();
		return false;
	}
	#end
