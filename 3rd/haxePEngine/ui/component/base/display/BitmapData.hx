...
import haxePEngine.ui.component.base.utils._internal.Float32Array;
import haxePEngine.ui.component.base.utils._internal.UInt8Array;
import haxePEngine.ui.component.base.utils._internal.UInt16Array;
import haxePEngine.ui.component.base.utils.ByteArray;
import haxePEngine.ui.component.base.utils.Endian;
import haxePEngine.ui.component.base.utils.Future;
import haxePEngine.ui.component.base.utils.Object;
...
#end
#if gl_stats
import haxePEngine.ui.component.base.display._internal.stats.Context3DStats;
import haxePEngine.ui.component.base.display._internal.stats.DrawCallContext;
#end
...
/**
	...
	image that you load with the `haxePEngine.ui.component.base.Assets` or
	`haxePEngine.ui.component.base.display.Loader` classes.
	This class lets you separate bitmap rendering operations from the
	internal display updating routines of haxePEngine.ui.component.base. By manipulating a
	...
	* `BitmapDataChannel.BLUE`
	...
	using the `haxePEngine.ui.component.base.display.Tilemap` class.
...
@:access(haxePEngine.ui.component.base.display3D.textures.TextureBase)
@:access(haxePEngine.ui.component.base.display3D.Context3D)
@:access(haxePEngine.ui.component.base.display.DisplayObject)
@:access(haxePEngine.ui.component.base.display.DisplayObjectShader)
@:access(haxePEngine.ui.component.base.display.Graphics)
@:access(haxePEngine.ui.component.base.display.Shader)
@:access(haxePEngine.ui.component.base.filters.BitmapFilter)
@:access(haxePEngine.ui.component.base.geom.ColorTransform)
@:access(haxePEngine.ui.component.base.geom.Matrix)
@:access(haxePEngine.ui.component.base.geom.Point)
@:access(haxePEngine.ui.component.base.geom.Rectangle)
#if !openfl_debug
@:fileXml('tags="haxe,release"')
@:noDebug
#end
@:autoBuild(haxePEngine.ui.component.base.utils._internal.AssetsMacro.embedBitmap())
class BitmapData implements IBitmapDrawable
{
	...
	**/
	...
	/**
		...
		bitmapData.encode(new Rectangle(0,0,640,480), new haxePEngine.ui.component.base.display.JPEGEncoderOptions(), byteArray);
		```
	...
	**/
	...
	#if (!openfl_doc_gen || (!js && !html5 && !flash_doc_gen))
	/**
		Creates a new BitmapData from bytes (a haxe.io.Bytes or haxePEngine.ui.component.base.utils.ByteArray)
		...
		@param	bytes	A haxe.io.Bytes or haxePEngine.ui.component.base.utils.ByteArray instance
	...
	**/
	...
	/**
		Creates a new BitmapData from haxe.io.Bytes or haxePEngine.ui.component.base.utils.ByteArray data
	...
	**/
	...
	public function draw(newBmd:BitmapData, mat:Matrix, a:Any, b:Any, c:Any, arg5:Bool) {}
}
#else
