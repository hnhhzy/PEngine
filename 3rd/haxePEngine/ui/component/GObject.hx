...
import haxePEngine.ui.base.event.DragEvent;
import haxePEngine.ui.base.event.GTouchEvent;
import haxePEngine.ui.base.event.IBubbleEvent;
...
import haxePEngine.ui.base.Relations;
import haxePEngine.ui.utils.ColorMatrix;
import haxePEngine.ui.utils.CompatUtil;
import haxePEngine.ui.utils.GTimers;
import haxePEngine.ui.utils.SimpleDispatcher;
...
import haxePEngine.ui.component.base.filters.ColorMatrixFilter;
...
@:meta(Event(name = "startDrag", type = "haxePEngine.ui.base.event.DragEvent"))

@:meta(Event(name = "endDrag", type = "haxePEngine.ui.base.event.DragEvent"))

@:meta(Event(name = "dragMoving", type = "haxePEngine.ui.base.event.DragEvent"))

@:meta(Event(name = "beginGTouch", type = "haxePEngine.ui.base.event.GTouchEvent"))

@:meta(Event(name = "endGTouch", type = "haxePEngine.ui.base.event.GTouchEvent"))

@:meta(Event(name = "dragGTouch", type = "haxePEngine.ui.base.event.GTouchEvent"))

@:meta(Event(name = "clickGTouch", type = "haxePEngine.ui.base.event.GTouchEvent"))
...
//    public var finalVisible(get, never):Bool;
    ...
    public var displayObject2(get, never):h2d.Object;
    ...
    private var _displayObject2:h2d.Object;
    ...
    @:final public function getGear(index:Int):GearBase
    {
        ...
        if (gear == null)
        {
            switch (index)
            {
                ...
                default:
                    throw new Error("PEngine: invalid gear index!");
            }
    ...
    private function checkGearDisplay():Void
    {
        ...
        {
            // if(this._gears[0] != null) {
            //     trace(cast(this._gears[0], GearDisplay).pages + ":" + connected);
            // }
    ...
    @:final private function get_displayObject2():h2d.Object
    {
        return _displayObject2;
    }

    @:final private function setDisplayObject2(value:h2d.Object):Void
    {
        _displayObject2 = value;
    }
    ...
    private function handlePositionChanged():Void
    {
        ...
        if (_displayObject2 != null)
        {
            ...
            _displayObject2.x = xv + _pivotOffsetX;
            _displayObject2.y = yv + _pivotOffsetY;
        }
