...
//    /** @private **/
//    private static function addInOut(clz:Class<Dynamic>, param:Array<String>):Void {
//        var name:String;
//        var i:Int = param.length;
//        while (i-- > 0) {
//            name = param[i].toLowerCase();
//            _lookup[name + ".easein"] = _lookup[name + "easein"] = Reflect.field(clz, "easeIn");
//            _lookup[name + ".easeout"] = _lookup[name + "easeout"] = Reflect.field(clz, "easeOut");
//            _lookup[name + ".easeinout"] = _lookup[name + "easeinout"] = Reflect.field(clz, "easeInOut");
//        }
//    }
}
